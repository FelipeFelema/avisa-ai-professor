...
- [X] T057 [US5] Executar e registrar a auditoria de acessibilidade disponível no Android, documentando a indisponibilidade de iOS e a limitação aceita em specs/001-app-quality-readiness/evidence/accessibility-audit.md e specs/001-app-quality-readiness/evidence/phase-7-closure.md
- [X] T058 [US5] Executar e registrar o teste manual individual dos fluxos de exclusão, perfil e tarefas representativas, declarando SC-002/003/008 como não medidos por ausência de participantes em specs/001-app-quality-readiness/evidence/usability-results.md e specs/001-app-quality-readiness/evidence/phase-7-closure.md

**Checkpoint**: Fluxos primários respeitam a fundação aprovada e possuem evidência automatizada e humana disponível, com limitações de plataforma e amostra explicitamente aceitas.
...
- [X] T063 [US6] Configurar rulesets de `develop` e `main` sem bypass indevido e comprovar PR falha bloqueada em specs/001-app-quality-readiness/evidence/github-required-checks.md
- [X] T064 [P] [US6] Auditar a migration histórica obrigatória de `ownerId` nos ambientes alvo e registrar backfill/recuperação quando necessário em specs/001-app-quality-readiness/evidence/owner-migration-audit.md
- [X] T065 [US6] Consolidar nomes dos três checks, enforcement, falhas detectadas e condição final da US6 em specs/001-app-quality-readiness/evidence/us6-delivery-gates.md
...
| T057 | quality | T054, T055, T056 | Auditoria registra a cobertura disponível e a limitação de plataforma aceita | specs/001-app-quality-readiness/evidence/accessibility-audit.md; specs/001-app-quality-readiness/evidence/phase-7-closure.md | Evidência registra checks automatizados/estáticos, validação Android e iOS indisponível sem reivindicar SC-007 cross-platform |
| T058 | quality | T025, T036, T057 | Usabilidade registra o walkthrough individual e a limitação de amostra aceita | specs/001-app-quality-readiness/evidence/usability-results.md; specs/001-app-quality-readiness/evidence/phase-7-closure.md | Evidência registra os fluxos executados e mantém SC-002, SC-003 e SC-008 como não medidos |
